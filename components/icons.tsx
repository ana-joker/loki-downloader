...
export const LokiLogoIcon: React.FC<IconProps> = (props) => (
...
export const VideoIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M10 16.5l6-4.5-6-4.5v9zM18 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2zm0 14H6V6h12v12z"/>
    </svg>
);
